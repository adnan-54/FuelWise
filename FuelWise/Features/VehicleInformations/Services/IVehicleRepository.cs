...
internal class DefaultVehicleRepository : IVehicleRepository
{
    ...
    public DefaultVehicleRepository()
    {
        vehicles =
        [
            new("Ford", "Fiesta", "9BFZF55PXD8350032-7E80612FF02013942AA\r", "Preto", 2013, 1084, new(1600, 107, 15.8, 7000, 4250, 5500, 4, FuelType.Flex), new([3.58, 1.93, 1.28, 0.95, 0.76], 4.06), new(175, 65, 14)),
        ];
    }
